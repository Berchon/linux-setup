...
- Implementa render de título opcional no `rectangle` com clipping e alinhamento básico em relação à borda. (E2/H2.1/T2.1.3) [PR #PENDING] [commit deb0e37]
- Adiciona testes de componente/fronteira para `rectangle` cobrindo fill, borda, título, clipping e validação de argumentos. (E2/H2.1/T2.1.4) [PR #PENDING] [commit TBD]
